		...
		<main>	
			...
			<div id="block_latest_works">
				...
				<div class="foto_latest_works2">
					<br><h2 style="text-align: center;"> Зарегистрируйтесь!</h2><br>
					...
					<form method="post">
 						...
 						<div class="form-group">
    						...
    						<input type="password" name="password" class="form-control" id="exampleInputPassword1" <?php if($error) {echo 'is-invalid';} ?> placeholder="Password">
  						</div>
