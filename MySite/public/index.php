	...
	<div class="container">
		...
		<main>	
			...
			<div id="block_latest_works">
				...
				<div>
						<?php
						include'../engine/massiv.php';
						?>
					</div>
				<div class="foto_latest_works">
					<div class="flex4">
						<a href="./img/flex1.png" target="_blank">
						<img src="./img/flex1.png"></a>
					</div>
					<div class="flex4">
						<a href="./img/flex2.png" target="_blank">
						<img src="./img/flex2.png"></a>
					</div>
					<div class="flex4">
						<a href="./img/flex3.png" target="_blank">
						<img src="./img/flex3.png"></a>
					</div>
					<div class="flex4">
						<a href="./img/flex4.png" target="_blank">
						<img src="./img/flex4.png"></a>
					</div>
					<div class="flex4">
						<a href="./img/flex5.png" target="_blank">
						<img src="./img/flex5.png"></a>
					</div>
					<div class="flex4">
						<a href="./img/flex6.png" target="_blank">
						<img src="./img/flex6.png"></a>
					</div>
					<div class="flex4">
						<a href="./img/flex7.png" target="_blank">
						<img src="./img/flex7.png"></a>
					</div>
					<div class="flex4">
						<a href="./img/flex8.png" target="_blank">
						<img src="./img/flex8.png"></a>
					</div>
					<div class="flex4">
						<a href="./img/flex9.png" target="_blank">
						<img src="./img/flex9.png"></a>
					</div>
				</div>
			</div>
